...
write("NEO_URL:", stderr())
write(Sys.getenv("NEO_URL", "https://tehr-discovery-index-hellooooo.cgrb.oregonstate.edu:7473"), stderr())

con <- neo4j_api$new(
  url = Sys.getenv("NEO_URL", "https://tehr-discovery-index-hellooooo.cgrb.oregonstate.edu:7473"),
